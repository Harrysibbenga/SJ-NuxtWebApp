...
export default {
  ...
  computed: {
    post() {
      const post = {
        id: this.$store.getters['about/getContent'].id,
        image: {
          id: this.$store.getters['about/getContent'].imgId,
          url: this.$store.getters['about/getContent'].url,
          alt: this.$store.getters['about/getContent'].alt,
        },
        content: {
          type: 'partner',
          title: this.$store.getters['about/getContent'].title,
          content: this.$store.getters['about/getContent'].content,
        },
      }
      return post
    },
