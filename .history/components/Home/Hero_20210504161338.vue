<template>
  <v-carousel cycle hide-delimiters show-arrows-on-hover height="auto">
            ...
            <v-col cols="6" lg="4" xl="3" class="pa-10">
              ...
              <v-subtitle>
                <v-btn
                  ...
                  class="ml-4 secondary primary--text font-weight-medium"
                  small
                >
                  Click for more
                </v-btn>
    ...
    <v-row class="mb-16 mt-n16">
      ...
      <v-col class="text-right mr-16">
        <v-row>
          <v-col v-for="(post, index) in posts" :key="i">
            <Icon />
          </v-col>
        </v-row>
        <v-btn
          :nuxt="true"
          to="/news"
          class="mt-n16 ml-16 secondary primary--text font-weight-medium"
          large
        >
          Click for acheive
        </v-btn>
