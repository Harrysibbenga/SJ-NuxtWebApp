<template>
  <div>
    <v-row>
      ...
      <v-col
        v-if="content.type == 'partner' || content.type == 'shop'"
        class="md-form"
        cols="12"
      >
        <v-text-field
          v-model.trim="postContent.link"
          label="Partner url"
        ></v-text-field>
      </v-col>

      <v-col v-if="content.type == 'car'" class="md-form" cols="12">
        <v-text-field
        ...
        <v-col cols="12">
          <v-row class="text-center">
            <v-col cols="12" lg="6">
              <h3>Start:</h3>
              <v-date-picker
                v-model.trim="postContent.dateFrom"
                :value="postContent.dateFrom"
                type="date"
              >
              </v-date-picker>
            </v-col>
            <v-col cols="12" lg="6">
              <h3>Finish:</h3>
              <v-date-picker
                v-model.trim="postContent.dateTo"
                :value="postContent.dateTo"
                type="date"
              >
              </v-date-picker>
            </v-col>
