...
export default {
  ...
  computed: {
    post() {
      const post = {
        id: this.$store.getters['headline/getContent'].id,
        image: {
          id: this.$store.getters['headline/getContent'].imgId,
          url: this.$store.getters['headline/getContent'].url,
          alt: this.$store.getters['headline/getContent'].alt,
        },
        content: {
          type: 'shop',
          title: this.$store.getters['headline/getContent'].title,
          link: this.$store.getters['headline/getContent'].link,
        },
      }
      return post
    },
