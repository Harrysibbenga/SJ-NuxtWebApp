<template>
  <div>
    ...
    <v-container>
      <v-row class="flex-column flex-center align-end">
        <v-col cols="12" class="white--text mx-auto">
          <div class="py-5" v-html="post.bio.content"></div>
        </v-col>
        <v-col cols="12" class="pt-2 white--text">
