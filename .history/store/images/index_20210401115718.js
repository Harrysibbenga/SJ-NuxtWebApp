...
import { imgCol,circuitImgCol,partnerImgCol, storage } from '@/services/firebase'
...
export const mutations = {
  ...
  SET_IMAGES_TYPE: (state, images) => {
    state.imagesType = images
  },
  SET_MSG: (state, msg) => {
    state.uploadMsg = msg
  },
  ...
  setImageByType({ commit }, type) {
    imgCol
      ...
      .onSnapshot((doc) => {
        ...
        commit('SET_IMAGES_TYPE', imagesArray)
      })
  },
